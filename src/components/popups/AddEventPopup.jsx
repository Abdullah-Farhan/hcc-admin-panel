    ...
    <div className="w-full bg-black/30 h-screen fixed inset-0 flex justify-center items-center">
      <div className="bg-white rounded-lg min-w-sm p-6 py-3">
        <div className="flex justify-between w-full mb-4">
          ...
          <X className="w-3 cursor-pointer hover:text-black text-gray-400 h-3" onClick={onClose}/>
        </div>
        <form onSubmit={handleSubmit} className="flex flex-col">
          ...
          <div className="w-full flex justify-end space-x-2">
            <button type="submit" className="hover:text-black text-gray-600 rounded-lg cursor-pointer text-sm" onClick={onClose}>
              Cancel
            </button>
            <button
              type="submit"
